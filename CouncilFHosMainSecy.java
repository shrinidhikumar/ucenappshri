...
public class CouncilFHosMainSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass groundSecy=new CouncilUserClass("Purnima Priyadarshini","Ground Floor Hostel Secretary","9651824851"," 180010026@iitdh.ac.in");
        CouncilUserClass firstSecy=new CouncilUserClass("Tarun Goyal","First Floor Hostel Secretary","6377868398"," 180010038@iitdh.ac.in");
        CouncilUserClass secondSecy=new CouncilUserClass("Sameer Anis Dohadwalla","Second Floor Hostel Secretary","9930437554"," 180020033@iitdh.ac.in ");
