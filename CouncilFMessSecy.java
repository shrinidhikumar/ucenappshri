...
public class CouncilFMessSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass messMem1=new CouncilUserClass("Karan Yogesh Anvekar","Mess Committee","9769719309","180020015@iitdh.ac.in");
        CouncilUserClass messMem2=new CouncilUserClass("Shreyas Mahesh Sathe","Mess Committee","167229258"," 180010033@iitdh.ac.in");
        CouncilUserClass messMem3=new CouncilUserClass("Vaishnavi Sameer Patil","Mess Committee","7038411894","180020039@iitdh.ac.in");
        CouncilUserClass messMem4=new CouncilUserClass("Rushikesh Dixit","Mess Committee","9109534276","180030037@iitdh.ac.in");
